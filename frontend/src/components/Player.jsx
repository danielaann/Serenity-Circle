...
function Player() {
  return (<>
    ...
    <div className='h-[10%] bg-base-200 flex justify-between items-center px-4 w-[80%]'>
       <div className='hidden lg:flex items-center gap-4 text-black'>
        <img className='w-10' src={songsData[0].image} />
            <div>
        ...
        <div className='flex flex-col items-center gap-1 m-auto'>
            ...
            <div className='flex items-center gap-5'>
                ...
                <div className='w-[60vw] max-w-[500px] bg-gray-300 rounded-full cursor-pointer'>
                    <hr className='h-1 border-none w-10 bg-accent rounded-full'></hr>
                </div>
                <p>3:20</p>
            </div>
        </div>
